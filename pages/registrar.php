...
require_once(__DIR__."/../classes/Autenticacao.php");
...
<head>
    ...
    <title>Gestão de Clientes - Registrar-se!</title>
</head>
...
<body>
    ...
    <div class="d-flex flex-column justify-content-center align-items-center" style="height: 100vh">
        ...
        if(isset($_POST["email"]) && isset($_POST["senha"])){
            ...
            $a = json_decode($a->registrar(),true);

            if(!$a['error']){

                echo '
                <div class="alert alert-success mt-4" style="width: 500px" role="alert">
                '.$a['message'].'
                </div> 
                ';
